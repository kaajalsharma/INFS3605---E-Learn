...
<body>
    <div class="header">
        <div class="row">
            <div class="col-lg-6">
                <span class="logo" style="color: #555555">QuizBiz</span>
            </div>
            <div class="col-md-4 col-md-offset-2">
                ...
                if (!(isset($_SESSION['username']))) {
                    ...
                    include_once 'dbConnection.php';
                    echo '<span class="pull-right top title1" ><span style="color:#555555"></span><a href="logout.php?q=account.php" style="color:#555555"><span class="glyphicon glyphicon-log-out" aria-hidden="true"></span>&nbsp;Logout</button></a></span>';
                }
                ?>
            </div>
        </div>
...
<tr><td style="vertical-align:middle"><b>Rank</b></td><td style="vertical-align:middle"><b>Name</b></td><td style="vertical-align:middle"><b>Branch</b></td><td style="vertical-align:middle"><b>Username</b></td><td style="vertical-align:middle"><b>Score</b></td></tr>';
    ...
    <div class="row footer">
        ...
        <div class="col-md-2 box">
            <a href="feedback.php" style="color:#555555;text-decoration:underline" onmouseover="this.style('color:yellow')" target="new">Feedback</a>
        </div>
