...
if (!(isset($_SESSION['username']))  || ($_SESSION['key']) != '54585c506829293a2d4c3b68543b316e2e7a2d277858545a36362e5f39') {
    ...
    include_once 'dbConnection.php';
    echo '<span class="pull-right top title1" ><a href="logout.php?q=account.php" style="color:#555555"><span class="glyphicon glyphicon-log-out" aria-hidden="true"></span>&nbsp;Logout</button></a></span>';
}
            ?>
